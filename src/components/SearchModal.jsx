        ...
        <div className={`fixed top-0 left-0 h-full w-full md:w-[385px] bg-[#1E213A] text-white transition-transform duration-300 ease-in-out transform ${isModalOpen ? 'translate-x-0' : '-translate-x-full'}`}>
            ...
            <div className="p-6 pt-12">
                ...
                <div className="space-y-4">
                    ...
                    <button onClick={() => handleLocationButtonClick('Barcelona')} className="w-full py-4 px-6 bg-[#1E213A] border border-customgraytwo rounded-md text-left text-lg focus:outline-none focus:ring-2 focus:ring-blue-500 font-raleway">Barcelona</button>
                    <button onClick={() => handleLocationButtonClick('Long Beach')} className="w-full py-4 px-6 bg-[#1E213A] border border-customgraytwo rounded-md text-left text-lg focus:outline-none focus:ring-2 focus:ring-blue-500 font-raleway">Long Beach</button>
                </div>
            </div>
        </div>
    );
